...
3. *bwkfanboy_generate*
   ...
   Doesn't take any command line parameters, just reads stdin expecting
   it to be a proper JSON-formatted object.
...
All utils write to <tt>/tmp/bwkfanboy.log</tt> file if permissions
allows it.
